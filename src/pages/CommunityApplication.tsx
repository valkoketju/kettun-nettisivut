...
const formSchema = z.object({
  ...
  skills: z.string().min(50, "Kerro taidoistasi vähintään 50 merkkiä"),
});
...
const CommunityApplication = () => {
  ...
  const role = searchParams.get("role") as keyof typeof roleNames;
  const roleName = roleNames[role] || "Community Role";
  ...
  const onSubmit = (data: FormData) => {
    console.log("Application submitted:", data, "Role:", role);
      ...
      <main className="container mx-auto px-4 pt-24 pb-20">
        ...
        <div className="max-w-3xl mx-auto">
          <Card className="p-8 border-border/50">
            <h1 className="text-3xl font-bold mb-2">{roleName} - Hakemus</h1>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              ...
              <div>
                <Label htmlFor="experience">Aiempi kokemus yhteisön hallinnasta/vastaavasta *</Label>
                <Textarea
                  id="experience"
                  {...register("experience")}
                  placeholder="Kerro aiemmasta kokemuksestasi..."
              ...
              <div>
                <Label htmlFor="motivation">Miksi haluat liittyä tiimiin? *</Label>
                <Textarea
                  id="motivation"
                  {...register("motivation")}
                  placeholder="Kerro miksi haluat liittyä ja mitä voit tuoda tiimille..."
              ...
              <div>
                ...
                <Textarea
                  ...
                  placeholder="Milloin pystyt auttamaan yhteisöä? Kuinka monta tuntia viikossa?"
              ...
              <div>
                <Label htmlFor="skills">Taitosi ja vahvuutesi *</Label>
                <Textarea
                  id="skills"
                  {...register("skills")}
                  placeholder="Mitä erityistaitoja tai vahvuuksia sinulla on tähän rooliin?"
                  className="min-h-[100px]"
                />
